...
- Listagens devem aceitar cenários previsíveis por URL para revisão visual: `mock=padrao`, `sem-clientes`, `sem-resultados` e `erro`. O estado sem dados oferece a ação principal; sem resultados limpa filtros; erro permite tentar novamente.
